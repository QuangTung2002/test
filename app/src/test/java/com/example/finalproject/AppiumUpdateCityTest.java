...
public class AppiumUpdateCityTest {
    ...
    public void testUpdateCityID01() throws InterruptedException {
    ...
    public void testUpdateCityID02() throws InterruptedException {
        MobileElement signinButton = driver.findElement(By.id("com.example.finalproject:id/textviewSignin"));
        signinButton.click();
        Thread.sleep(500);
        MobileElement usernameEditText = driver.findElement(By.id("com.example.finalproject:id/editTextUsername"));
        ...
        manageCityText.click();
        Thread.sleep(500);
        MobileElement findCity = driver.findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.example.finalproject:id/textviewNameCity\" and @text=\"Da Lat\"]"));
        findCity.click();
        MobileElement editCity = driver.findElement(By.id("com.example.finalproject:id/editNameCity"));
        editCity.sendKeys("Gia Lai ");
        MobileElement updateCityButton = driver.findElement(By.id("com.example.finalproject:id/buttonAddCity"));
        updateCityButton.click();
        WebDriverWait wait = new WebDriverWait(driver, 5);
